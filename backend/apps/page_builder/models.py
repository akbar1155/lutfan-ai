...
class InvitationPage(TimeStampedModel):
    ...
    event_slug = models.CharField(max_length=32, blank=True, default="nikoh")
    subtype_slugs = models.JSONField(default=list, blank=True)
    title = models.CharField(max_length=120, blank=True, default="")
    ready_text_id = models.CharField(max_length=32, blank=True, default="classic1")
    main_text = models.TextField(blank=True, default="")
    event_date = models.DateField(null=True, blank=True)
    event_time = models.TimeField(null=True, blank=True)
    family_signature = models.CharField(max_length=80, blank=True, default="")
    person_name = models.CharField(max_length=80, blank=True, default="")
    child_name = models.CharField(max_length=50, blank=True, default="")
